...
class OperationLogRow(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_operation_project_created", "project_id", "created_at"),
        Index("ix_operation_status_created", "status", "created_at"),
    )

    id: Mapped[str] = mapped_column(String(64), primary_key=True)
    project_id: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    operation_type: Mapped[str] = mapped_column(String(120), nullable=False, index=True)
    actor_type: Mapped[str] = mapped_column(String(30), nullable=False, default="user")
    actor_id: Mapped[str] = mapped_column(String(120), nullable=False, default="local")
    request_id: Mapped[str] = mapped_column(String(64), nullable=False, default="")
    turn_id: Mapped[str] = mapped_column(String(64), nullable=False, default="", index=True)
    ...
    affected_entities_json: Mapped[str] = mapped_column(Text, nullable=False, default="[]")
    inverse_json: Mapped[str] = mapped_column(Text, nullable=False, default="null")
    result_json: Mapped[str] = mapped_column(Text, nullable=False, default="null")
